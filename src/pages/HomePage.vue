<template>
  <div class=" w-full bg-background1 ">
    <div class="section1 min-h-screen relative">
      <button
        class="absolute right-10 top-10  border border-white rounded-md px-4 py-1 bg-[#0a0c43] text-white font-bold hover:bg-[#034596] text-center">L
        O G I N</button>
    ...
    <section class="section2 min-h-screen relative">
      ...
      <div
        ...
        <h1 class="text-[40px] text-white font-bold">Try your chalange with multiple
          questions types</h1>
      </div>
    </section>
  </div>
